...
function Why() {
  ...
  return (
     <div>
          ...
          Leveraging our years of extensive experience in emerging digital technologies, we have built innovative technology solutions for industry incumbents solving their critical business challenges.
          </div>
           <br/>

    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <div className="card" style={{ width: "15rem", marginRight: '20px', borderColor: "white"}}><br/>
